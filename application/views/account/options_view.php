...
<form name="form_product_options" id="form_product_options" action="" method="POST">
	...
	<div class="form-group">
		<label for="who_can_see_account_balance" class="control-label ff-1 fs-16"><?php lang('Account balance, who can see it?'); ?></label>
		<select name="who_can_see_account_balance" id="who_can_see_account_balance" class="form-control input-lg valid">
    ...
    <div class="form-group">
		<label for="who_can_edit_account_card" class="control-label ff-1 fs-16"><?php lang('Who can edit the account cards?'); ?></label>
		<select name="who_can_edit_account_card" id="who_can_edit_account_card" class="form-control input-lg valid">
