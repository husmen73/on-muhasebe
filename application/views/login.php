                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-prepend input-group">
                            ...
                            <input type="text" id="email" name="email" class="form-control input-lg ff-1 required email" placeholder="<?php lang('E-mail'); ?>" minlength="3" maxlength="50" value="">
                        </div>
                    </div> <!-- /.form-group -->
                    <div class="form-group">
                        ...
                        <div class="input-prepend input-group">
                            ...
                            <input type="password" id="password" name="password" class="form-control input-lg ff-1 required" placeholder="<?php lang('Password'); ?>" minlength="4" maxlength="32" value="">
                        </div>
                    </div>
